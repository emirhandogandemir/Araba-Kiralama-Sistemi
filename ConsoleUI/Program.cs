...
namespace ConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("\n\nId'si 2 olan araba: \nId\tColor Name\tBrand Name\tModel Year\tDaily Price\tDescriptions");
            //Car carById = carManager.GetById(5);
            ...
            {
                Console.WriteLine("araba adi : " + car.CarName + " / araba markasi : "+car.BrandName+" / araba rengi : "+car.ColorName+" / araba günlük fiyatı : "+car.DailyPrice);
            }
